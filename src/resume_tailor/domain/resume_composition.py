...
STRATEGY_UTILIZATION_ACCEPTABLE_FLOOR = 0.76
STRATEGY_UTILIZATION_ACCEPTABLE_CEILING = 0.95
STRATEGY_UTILIZATION_PREFERRED_FLOOR = 0.82
STRATEGY_UTILIZATION_PREFERRED_CEILING = 0.92
STRATEGY_UTILIZATION_IDEAL = 0.87
TEMPLATE_V1_SEVERE_UNDERFILL_FLOOR = 0.69
RESUME_COMPOSITION_CONTRACT_VERSION = "strategy-underfill-expansion-v12"
