...
STRATEGY_UTILIZATION_ACCEPTABLE_FLOOR = 0.84
STRATEGY_UTILIZATION_ACCEPTABLE_CEILING = 0.95
STRATEGY_UTILIZATION_PREFERRED_FLOOR = 0.88
STRATEGY_UTILIZATION_PREFERRED_CEILING = 0.93
STRATEGY_UTILIZATION_IDEAL = 0.90
TEMPLATE_V1_SEVERE_UNDERFILL_FLOOR = 0.75
RESUME_COMPOSITION_CONTRACT_VERSION = "strategy-underfill-exhaustion-v13"
