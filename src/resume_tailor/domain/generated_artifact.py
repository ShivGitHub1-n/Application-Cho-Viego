...
class GenerationStage(StrEnum):
    ...
    COVER_LETTER_EVIDENCE_SELECTION = "cover_letter_evidence_selection"
    ...
    COVER_LETTER_QUALITY_GATES = "cover_letter_quality_gates"
    ...
    COVER_LETTER_PAGE_FIT = "cover_letter_page_fit"
